"""unlimiteddelivery_22161 URL Configuration
...
admin.site.site_header = "Unlimiteddelivery"
admin.site.site_title = "Unlimiteddelivery Admin Portal"
admin.site.index_title = "Unlimiteddelivery Admin"

# swagger
api_info = openapi.Info(
    title="Unlimiteddelivery API",
    default_version="v1",
    description="API documentation for Unlimiteddelivery App",
)
